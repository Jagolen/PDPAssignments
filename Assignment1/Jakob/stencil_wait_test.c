...
int main(int argc, char **argv) {
    ...
    */
	...
	//Gathering each contribution from the processess and the times
	MPI_Gather(l_in, vals_per_pc, MPI_DOUBLE, in_out, vals_per_pc, MPI_DOUBLE, 0, cart);
